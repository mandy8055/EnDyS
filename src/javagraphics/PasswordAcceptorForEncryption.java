...
import securityprovider.EncryptorAndDecryptor;
 ...
 */
public class PasswordAcceptorForEncryption extends javax.swing.JFrame {
    private File[] listOfFilesAndFolders;
    public PasswordAcceptorForEncryption(File[] listOfFilesAndFolders)
    {
    ...
    private void initComponents() {
        ...
        suggestionLabel.setText("Try to enter the password containing numbers, letters and synbols for better security of the file(s)");
